                        ...
                        <Grid item container>
                            ...
                            <div>
                                ...
                                <div className={classes.techDesc}>
                                    Serverless computing offers a number of
                                    advantages over traditional cloud-based or
                                    server-centric infrastructure. For many
                                    developers, serverless architectures offer
                                    greater scalability, more flexibility, and
                                    quicker time to release, all at a reduced
                                    cost.
                                </div>
                            </div>
                        </Grid>
                ...
                >
                    ...
                    >
                        ...
                        <Typography variant='subtitle1'>
                            Integrating serverless components to meet the
                            business needs.
                        </Typography>
                        <Button
                            component={Link}
                ...
                >
                    <Grid item>
                        <Grid item container>
                            ...
                            <div>
                                <div className={classes.techTitle}>
                                    P8 Rally Event System
                                </div>
                                <div className={classes.techDesc}>
                                    Full serverless solution, providing
                                    management of events, leaders and
                                    participants.
                                </div>
                                <Button
                                    component={Link}
                    ...
                    <Grid item>
                        <Grid item container>
                            <div>
                                ...
                                <div className={classes.techDesc}>
                                    Full serverless solution that allows an
                                    organization to plan, manage and support
                                    meetings, which includes all planning
                                    assignments, topical meetings during each
                                    event, as well as leadership planning and
                                    development.
                                </div>
                                <Button
                                    component={Link}

...
export default function P8Rally(props) {
  ...
  return (
    <Box>
        ...
        <Grid container direction="column" className={classes.gridContainerMain}>
        {/*  //   SECTION 1     */}
        <Typography variant="h4">Software Engineering</Typography>
        <Grid item className={classes.gridItemA}>
        <Grid container direction="row"  columns={{ xs: 1, md: 2 }} className={classes.gridContainerA}>
            <Grid item xs={1} md={1} className={classes.gridItemA1}>
            ...
            <Grid item xs={1} md={1} className={classes.gridItemA2}>
            <Lottie
        ...
        <Grid item className={classes.gridItemB}>
          <Grid container direction="row" className={classes.gridContainerB}>
        ...
        <Grid item className={classes.gridItemC}>
          <Grid container direction="row" className={classes.gridContainerC}>
